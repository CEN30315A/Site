...
export default {
    ...
    faq:[
        ...
        {id: 4, question: 'What is the procedure for the polydactyly removal using the DigiClamp?', answer: <div class = "button"> <a href = "https://drive.google.com/open?id=1weX5epIo6lPkBhH4VAbbb__DDRDuYeY_" target = "blank"> Click this to read more about the procedure</a> </div> },
      ],
}
